...
<body>
	...
	if(categoryID == null ){
	categoryID = request.getParameter("job");
	}
		...
		<form class="was-validated">
			...
			<div class="viewComponent">
				...
				<div class="viewContent">
					...
					<div class=form-control style="border-color: #28a745; height:100%; "><%= Bbs.getContent().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br>") %></div>
				</div>
			
			
				<div class="viewBtn">
					<div class="writeSubmitBtn">
					<a href="newsBbs.jsp" class="writeSubmitBtn">목록</a>
